using UnityEngine;
    ...
    public class SphericalVolumeHierarchyLevelDetails
    {
        ...
        [SerializeField] internal int amountOfOuters = 1;
        [SerializeField] internal int amountOfCountables = 0;
        [SerializeField] internal int amountOfContainers = 0;
        [SerializeField] internal int amountOfNotCountables = 0;

        public int AmountOfOuters { get => this.amountOfOuters; set => this.amountOfOuters = value; }
        public int AmountOfCountables { get => this.amountOfCountables; set => this.amountOfCountables = value; }
        public int AmountOfContainers { get => this.amountOfContainers; set => this.amountOfContainers = value; }
        public int AmountOfNotCountables { get => this.amountOfNotCountables; set => this.amountOfNotCountables = value; }
        ...
        public MinAndMaxFloat ContainableRadiusRange { get => ContainableInputInformation.minAndMaxRadiusMultipers; set => ContainableInputInformation.minAndMaxRadiusMultipers = value; }
        public Color ContainableColor { get => ContainableInputInformation.color; set => ContainableInputInformation.color = value; }
        ...
        public MinAndMaxInt NotCountableAmountOfChildren { get => NotCountableInputInformation.amountOfChildrenRange; }

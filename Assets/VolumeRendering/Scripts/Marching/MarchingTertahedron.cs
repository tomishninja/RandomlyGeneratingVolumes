...
namespace MarchingCubesProject
{
    public class MarchingTertrahedron : Marching
    {
        ...
        public MarchingTertrahedron(int surfaceMin = 1, int surfaceMax = int.MaxValue) : base(surfaceMin, surfaceMax)
        {
        ...
        private void MarchTetrahedron(IList<Vector3> vertList, IList<int> indexList)
        {
            ...
            for (i = 0; i < 4; i++) if (TetrahedronValue[i] >= SurfaceMin && TetrahedronValue[i] <= SurfaceMax) flagIndex |= 1 << i;
